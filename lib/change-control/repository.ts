...
function mapSummary(row: JsonObject): M03ChangeRequestSummary { return {
  ...
  supersedes_request_id: nullableString(row, "supersedes_request_id"), created_by_id: stringValue(row, "created_by_id"), created_by_name: stringValue(row, "created_by_name"),
...
function mapEvent(row: JsonObject): M03AuditEvent { return { id: numberValue(row, "id"), event_type: stringValue(row, "event_type"), from_status: nullableString(row, "from_status") as M03Status | null, to_status: nullableString(row, "to_status") as M03Status | null, revision_id: nullableString(row, "revision_id"), actor_name: nullableString(row, "actor_name"), actor_email: nullableString(row, "actor_email"), actor_role: nullableString(row, "actor_role") as M03AuditEvent["actor_role"], trusted_ip: nullableString(row, "trusted_ip"), metadata: objectValue(row, "metadata"), created_at: stringValue(row, "created_at") }; }
